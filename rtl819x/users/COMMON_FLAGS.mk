...
ifeq ($(CONFIG_RTL_MESH_SUPPORT),y)
		...
		ifeq ($(CONFIG_RTL_MESH_METRIC_REFINE),y)
		MESH_EXTRA_CONFIG_FLAGS += -DRTK_MESH_METRIC_REFINE
		endif
endif
...
ifeq ($(CONFIG_APP_VSFTPD_NO_START_BY_SYSCONF),y)
COMMON_CFLAGS += -DCONFIG_APP_VSFTPD_NO_START_BY_SYSCONF
endif
endif
...
ifeq ($(CONFIG_APP_ZAPI_BLE_SERVICE),y)
COMMON_CFLAGS += -DCONFIG_APP_ZAPI_BLE_SERVICE
endif
ifeq ($(CONFIG_APP_PCRE), y)
TARGET_CFLAGS += -DWITH_PCRE
endif
ifeq ($(CONFIG_ZYXEL_WSR30), y)
TARGET_CFLAGS += -D$(PROJ_NAME)
endif
ifeq ($(CONFIG_APP_ZAPI_MODULE), y)
export ZAPI_CFLAGS
endif
